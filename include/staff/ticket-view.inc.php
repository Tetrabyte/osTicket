...
<?php                   } # end if ($user) ?>
...
</svg></button>  <?php if (!empty($ticket->getPhoneNumber())) { ?><button class='btn btn-warning btn-sm' onclick="location.href='tel://<?php echo $ticket->getPhoneNumber(); ?>'" style="--bs-btn-padding-y: .25rem !important; --bs-btn-padding-x: .5rem !important; "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-telephone" viewBox="0 0 16 16">
  ...
  <button class='btn btn-primary btn-sm' onclick="location.href='https://tickets.remoteit.co.uk/scp/UserSearch.php?keyword=<?php echo $ticket->getEmail(); ?>'" style="--bs-btn-padding-y: .25rem !important; --bs-btn-padding-x: .5rem !important; ">
