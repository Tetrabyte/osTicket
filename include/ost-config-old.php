...
define('SECRET_SALT','dNTJ755aoV6hZq0xQQo5MF5Q4egGt6oM');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','support@tickets.remoteit.co.uk');
...
define('DBNAME','webdev_osticket');
define('DBUSER','osticketsql');
define('DBPASS','Pgxj8&61');
